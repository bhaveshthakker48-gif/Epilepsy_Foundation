...
import com.india.epilepsyfoundation.databinding.ActivityInformationBinding
...
class InformationActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleTextView.text = getString(R.string.lbl_title)

        binding.toolbar.addView(customView)

        // Your click listeners
        binding.firstInfoName.setOnClickListener {
            gotoScreen(UnderstandingEpilepsyActivity::class.java)
        }

        binding.secondInfoName.setOnClickListener {
            gotoScreen(MedicationEpilepsyActivity::class.java)
        }

        binding.thirdInfoName.setOnClickListener {
            gotoScreen(EmergencyManagementActivity::class.java)
        }

        binding.fourthInfoName.setOnClickListener {
            gotoScreen(VideoAwarenessActivity::class.java)
        }
