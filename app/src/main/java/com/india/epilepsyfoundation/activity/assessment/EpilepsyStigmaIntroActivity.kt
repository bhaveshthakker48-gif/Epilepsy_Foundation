...
import com.india.epilepsyfoundation.databinding.ActivityEpilepsyStigmaIntroBinding
import com.india.epilepsyfoundation.utils.SharedPreference
import java.util.Locale

class EpilepsyStigmaIntroActivity : BaseActivity() {

    private lateinit var binding: ActivityEpilepsyStigmaIntroBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        setLocale(getCurrentLanguage())
        super.onCreate(savedInstanceState)
        binding = ActivityEpilepsyStigmaIntroBinding.inflate(LayoutInflater.from(this))
        ...
        titleTextView.text = getString(R.string.Stigmatitle)

        binding.toolbar.addView(customView)

        binding.btnResult.setOnClickListener {
            val intent = Intent(this, EpilepsyStigmaQuestionActivity::class.java)
