...
import com.india.epilepsyfoundation.databinding.ActivityQuestionnaireBinding
...
class QuestionnaireActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnGo.setOnClickListener {
            gotoScreen(QSPersonalDetailsActivity::class.java)
        }

        binding.btnViewResult.setOnClickListener {
            gotoScreen(QSQuestionsResultActivity::class.java)
        }
    }
