...
import com.india.epilepsyfoundation.activity.assessment.EpilepsyStigmaQuestionActivity
import com.india.epilepsyfoundation.adapter.QolieResultAdapter
import com.india.epilepsyfoundation.adapter.QuestionsListAdapter
import com.india.epilepsyfoundation.databinding.ActivityQsquestionsBinding
import com.india.epilepsyfoundation.databinding.ActivityQsquestionsResultBinding
...
class QSQuestionsResultActivity : BaseActivity() {

    private lateinit var binding: ActivityQsquestionsResultBinding
    private lateinit var adapter1: QuestionsListAdapter
    private val viewModel: QuestionnaireViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        setLocale(getCurrentLanguage())
        super.onCreate(savedInstanceState)
        binding = ActivityQsquestionsResultBinding.inflate(LayoutInflater.from(this))
        ...
        adapter1 = QuestionsListAdapter(emptyList())
        binding.questionRecyclerview.adapter = adapter1
    ...
    private fun fetchQuestionnaireData() {
        viewModel.getAllQuestionnaireData { visits ->
            if (visits.isEmpty()) {
