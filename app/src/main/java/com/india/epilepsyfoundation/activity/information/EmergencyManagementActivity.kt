...
import com.india.epilepsyfoundation.databinding.ActivityEmergencyManagementBinding
import com.india.epilepsyfoundation.utils.SharedPreference
import java.util.Locale

class EmergencyManagementActivity : BaseActivity() {

    private lateinit var binding: ActivityEmergencyManagementBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEmergencyManagementBinding.inflate(LayoutInflater.from(this))
        ...
        titleTextView.text = getString(R.string.lbl_emergency_mgmt)

        binding.toolbar.addView(customView)

        val combinedHtml = getString(R.string.txt_epi_mgmt)
    ...
    private fun playAudioForCurrentLanguage() {
        val audioResId = when (getCurrentLanguage()) {
            "hi" -> R.raw.emergency_management_hindi
            "mr" -> R.raw.emergyncy_management_marathi
            else -> R.raw.emergency_management_english
        }
