...
import com.india.epilepsyfoundation.databinding.ActivityAllMessagesBinding
import com.india.epilepsyfoundation.fragments.AlertsFragment
import com.india.epilepsyfoundation.fragments.ReminderFragment
...
class AllMessagesActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAllMessagesBinding.inflate(LayoutInflater.from(this))
        ...
        titleTextView.text = getString(R.string.tile_message)
        ...
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.tab_alerts)))
