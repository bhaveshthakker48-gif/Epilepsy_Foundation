...
import com.india.epilepsyfoundation.databinding.ActivityAssessmentBinding
...
class AssessmentActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleTextView.text = getString(R.string.assessment_form)
        binding.toolbar.addView(customView)

        binding.firstAssName.setOnClickListener {
            gotoScreen(QoliEInstructionActivity::class.java)
        }

        binding.secondAssName.setOnClickListener {
            gotoScreen(EpilepsyStigmaIntroActivity::class.java)
        }

        binding.thirdAssName.setOnClickListener {
            gotoScreen(WHODASIntroActivity::class.java)
        }

        binding.btnResult.setOnClickListener {
            gotoScreen(ViewAssessmentResultActivity::class.java)
        }
    }
