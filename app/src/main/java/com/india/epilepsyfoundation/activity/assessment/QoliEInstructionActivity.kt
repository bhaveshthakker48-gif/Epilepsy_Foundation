...
import com.india.epilepsyfoundation.databinding.ActivityQoliEinstructionBinding
import com.india.epilepsyfoundation.utils.SharedPreference
import java.util.Locale

class QoliEInstructionActivity : BaseActivity() {

    private lateinit var binding: ActivityQoliEinstructionBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        setLocale(getCurrentLanguage())
        super.onCreate(savedInstanceState)
        binding = ActivityQoliEinstructionBinding.inflate(LayoutInflater.from(this))
        ...
        binding.btnStart.setOnClickListener {
            val intent = Intent(this, QoliEQuestionActivity::class.java)
