...
import com.india.epilepsyfoundation.databinding.ActivityEpDetectorBinding
import com.india.epilepsyfoundation.utils.SharedPreference
import java.util.Locale

class EpDetectorActivity : BaseActivity() {

    private lateinit var binding : ActivityEpDetectorBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        setLocale(getCurrentLanguage())
        super.onCreate(savedInstanceState)
        binding = ActivityEpDetectorBinding.inflate(LayoutInflater.from(this))
        ...
        binding.btnResult.setOnClickListener {
            val intent = Intent(this, EpDetectorContactActivity::class.java)
